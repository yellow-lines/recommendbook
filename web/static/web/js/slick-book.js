    ...
    Slick = (function() {
        ...
        function Slick(element, settings) {
            ...
            _.defaults = {
                ...
                arrows: true,
                asNavFor: null,
                prevArrow: '<button style="text-align: center"  type="button" data-role="none" class="slick-prev" aria-label="Previous slide" tabindex="0" role="button">❮</button>',
                nextArrow: '<button style="text-align: center" type="button" data-role="none" class="slick-next" aria-label="Next slide" tabindex="0" role="button">❯</button>',
                autoplay: false,
                autoplaySpeed: 3000,
                centerMode: false,
                centerPadding: '50px',
